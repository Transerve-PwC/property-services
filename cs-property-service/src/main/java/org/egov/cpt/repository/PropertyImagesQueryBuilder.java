...
public class PropertyImagesQueryBuilder {
	...
	private final String paginationWrapper = "SELECT * FROM "
			+ "(SELECT *, DENSE_RANK() OVER (ORDER BY piModifiedTime desc) offset_ FROM " + "({})" + " result) result_offset "
	...
	public String getPropertyImagesSearchQuery(DuplicateCopySearchCriteria criteria, Map<String, Object> preparedStmtList) {
