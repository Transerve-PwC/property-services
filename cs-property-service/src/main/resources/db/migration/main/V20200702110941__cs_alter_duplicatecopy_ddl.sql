...
RENAME COLUMN transit_number TO property_id;
...
ALTER TABLE cs_pt_duplicatecopy_applicant RENAME COLUMN property_id TO application_id;
...
RENAME COLUMN property_id TO application_id;

--documnet
ALTER TABLE cs_pt_duplicatecopy_document DROP CONSTRAINT fk_cs_pt_duplicatecopy_document;

ALTER TABLE cs_pt_duplicatecopy_document RENAME COLUMN propertydetailid TO application_id;
